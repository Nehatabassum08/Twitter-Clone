            ...
            <div className='profile-content'>
                <div className='profile-header'>
                    ...
                    <div className='profile-header-info'>
                        ...
                        <p className='profile-post-count'>10 posts</p>
                    </div>
                </div>
                <div className='profile-banner-container'>
                    <img src="https://pbs.twimg.com/profile_banners/1581707412922200067/1693248932/1080x360" alt="banner" className='profile-banner' />
                ...
                <div className='profile-action'>
                    {
                        profile?._id === user?._id ? (
                            ...
                            <button onClick={followAndUnfollowHandler} className='follow-button'>
